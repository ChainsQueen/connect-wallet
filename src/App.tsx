...
function App() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-purple-950 dark:to-slate-900">
      ...
      <header className="text-center py-12 px-8 bg-white/60 dark:bg-purple-900/20 border-b border-purple-200/50 dark:border-purple-500/20 backdrop-blur-sm">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 dark:from-purple-300 dark:via-blue-400 dark:to-cyan-400 bg-clip-text text-transparent">
          Wallet Integration Demo
        </h1>
        <p className="text-lg text-slate-700 dark:text-purple-200/80 max-w-2xl mx-auto leading-relaxed">
