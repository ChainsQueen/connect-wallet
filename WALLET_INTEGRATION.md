...
This project implements a complete Ethereum wallet connection feature using **ethers.js v6**, allowing users to connect their MetaMask wallet, view their address, check their balance, and disconnect.
